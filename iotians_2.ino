// Arduino gps car accident location tracking system using Neo 6m gps module and sim900A //gsm module.
...
int sensor = A1; // tilt sensor connected here
...
void sendSMS(String message)
{
  ...
  delay(100);
 SIM900.println("AT + CMGS = \"+916353129149\"");  // recipient's mobile number, in international format
  delay(100);
...
int fahad2 = (longitude - datareal2 ) * 100000;
 ...
 textForSMS = textForSMS + " Electronic Clinic, Tilt sensor controlled section";  
  sendSMS(textForSMS);
...
int fahad2 = (longitude - datareal2 ) * 100000;
  ...
  textForSMS = textForSMS + " Latitude: ";
   textForSMS.concat(datareal);
    textForSMS = textForSMS + ".";
  textForSMS.concat(fahad);
 textForSMS = textForSMS + " Hey Mann Patel,this is an alert to let you know that your car at following location have been in a car accident.";  
  sendSMS(textForSMS);
  Serial.println(textForSMS);
  Serial.println("message sent.");
  delay(5000);
